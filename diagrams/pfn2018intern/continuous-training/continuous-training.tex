...
\node[textbox] (textbox) at (1,2) {$V(S)\neq0$ if $t$ is \texttt{done}};

% EPISODE 1

\node[state] (s0_1) at (0,-5) {$S_0$};
\node[state] (s1_1) [right=of s0_1, label={\texttt{done=False}}] {$S_1$};
\node[state] (s2_1) [right=of s1_1, label={[name=terminus_1]\texttt{done=True}}] {$S_2$};

\node[action] (a0_1) at ([yshift=-1cm]$(s0_1)!0.5!(s1_1)$) {$A_0$};
\node[action] (a1_1) at ([yshift=-1cm]$(s1_1)!0.5!(s2_1)$) {$A_1$};

\node[reward] (r1_1) [above=of s1_1] {$R_1$};
\node[reward] (r2_1) [above=of s2_1] {$R_2$};

\draw[->, thick] (s0_1) -- (s1_1) {};
\draw[->, thick] (s1_1) -- (s2_1) {};
\draw[->, thick] (a0_1) -- (s1_1) {};
\draw[->, thick] (a1_1) -- (s2_1) {};
\draw[dashed, thick] (s1_1) -- (r1_1) {};
\draw[dashed, thick] (s2_1) -- (r2_1) {};

\node[textbox] (textbox_1) at (1,-3) {$V(S)\neq0$ if $t$ is \texttt{done}};

\draw[->, thin] (s2) to[out=-45, in=120] (s0_1) {};

\begin{scope}[on background layer]
    \node [episode, fit=(textbox)(s0)(r2)(a1)(terminus), label={Episode=0}] {};
    \node [episode, fit=(textbox_1)(s0_1)(r2_1)(a1_1)(terminus_1), label={Episode=1}] {};
\end{scope}
