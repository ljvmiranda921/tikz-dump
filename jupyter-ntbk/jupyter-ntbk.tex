...
\begin{scope}[on background layer]
    \node[area, fit=(Step1)(Step1Label), label={[align=left, xshift=-2cm]\texttt{remoteuser@remotehost}}] (remote) {};
    \node[area, fit=(Step2Label)(Step2)(Step3), label={[align=left, xshift=-4.5cm]\texttt{localuser@localhost}}] (local) {};
\end{scope}
